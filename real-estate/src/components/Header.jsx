...
const Header = () => {
  return (
    ...
    <Navbar/>
    <div className="container text-center mx-auto py4 px-6 md:px-20 lg:px-32 text-white">
        ...
        <div className='space-x-6 mt-16'>
          <a href="#Projects" className='border border-white px-8 p-3 rounded'>Projects</a>
          <a href="#Contact" className='bg-blue-500   px-8 p-3 rounded'>Contact us</a>
        </div>
      </div>
